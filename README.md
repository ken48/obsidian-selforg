# 2026-03-25 Самоорганизация: от потребностей к календарю

<img src="imgs/kdpv.jpg" width="1500">

О самоорганизации написано очень много. При этом сколько я ни пробовал готовых систем, в чистом виде они у меня не приживались. Со временем из разных идей и собственного опыта у меня сложилась своя. В статье покажу, на чем она основана и как реализована на практике в TickTick.

Иногда по ходу текста будет встречаться эмодзи 💡 — им я отмечаю нюансы, связывающие концепции с практикой.

Также в некоторых местах я буду указывать английский вариант понятия. Большая часть этих концепций зародилась в англоязычной среде, поэтому оригинальные формулировки точно будут не лишними.
...
💡 Когда возможностей больше, чем ресурса, между делами возникает конкуренция. Без системы человек живет реактивно: делает то, что в моменте сильнее требует внимания, выпуская из виду все остальное.

Для меня функции системы самоорганизации такие.
...
3. Дать шанс большим изменениям. Большие изменения — это цепочка шагов. Без системы большое часто остается в статусе "хорошо бы когда-нибудь".
...
Пересечение этих кругов — вещи, которые нас волнуют и на которые мы можем влиять. И опять не все из этой зоны требует системной организации. В жизни должно оставаться место для спонтанности — небольшие решения, ценность которых как раз в свободе. В итоге из пересечения кругов забот и влияния я выделяю еще одно подмножество — те вопросы, о которых я решил заранее позаботиться.

<img src="imgs/my-responsibility-rings.png" width="500">

Я называю это кругом ответственности. Это все, где у меня есть обязательства перед другими или самим собой.
...
Получается, что предмет организации — это ĸруг ответственности:
...
Итак, круг ответственности определяет, что попадает в систему. Теперь нужно понять, что с этим делать.
...
## Психологическая основа треугольника Энтони

Разобранные выше приемы по сути обслуживают удовлетворение потребностей. Этот процесс можно представить как последовательность шагов — своего рода пайплайн, в котором результат предыдущего шага становится входом для следующего.

```
Осознание потребности → Планирование → Действие → Оценка результата
```

Если этот пайплайн прерывается, возникает ощущение незавершенности и неудовлетворенности. Система самоорганизации не устраняет все возможные причины прерывания этого пайплайна. Она не заменяет ни ресурс, ни мотивацию, ни психологическую работу. Но она может поддерживать этот пайплайн на каждом этапе — от осознания потребности до оценки результата. Связь с треугольником Энтони выглядит так:

- осознание потребности → стратегия — система помогает фиксировать замеченные потребности;

- планирование → тактика — система помогает создавать и поддерживать структуру планов;

- действие → операция — система борется с прокрастинацией и хаосом действий за счёт однозначности календаря;

- оценка результата → поддержка системы и актуализация стратегии — система помогает завершать начатое через регулярные ретроспективы.
...
Во многих системах самоорганизации используется инбокс — место, куда складываются все входящие мысли, задачи и идеи. Проблема в том, что инбокс требует регулярного разбора. Если проверять его редко, там могут зависать срочные задачи. Если проверять слишком часто, это создает еще одну регулярную задачу.
...
Например, мой домен Joy выглядит так:
...
Итого: 24 минуты и опоздание примерно на 9 минут. Эти 9 минут вычитаются из занятия, потому что день логопеда расписан поминутно. Он не может просто войти в ваше "положение".
...
- Система позволяет закладывать время на переключение контекста между активностями — например, между индивидуальной работой и встречами. Я ставлю слот на встречу с учетом необходимых мне 15 минут: переключиться и освежить повестку.

- Система помогает реально оценивать, сколько у меня есть времени на важные, но несрочные задачи. Когда в календаре уже учтены встречи, слоты на подготовку к ним, обед и короткие перерывы, становится видно, сколько времени остается на другие виды активности: код-ревью, наставничество, разработку, планирование рефакторинга.

- Система удерживает границы рабочего дня. Когда в календаре заранее учтены обязательные дела до и после работы, день перестает "расползаться" и не загоняет в ресурсный долг.
